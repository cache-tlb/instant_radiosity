...
#ifndef VSMATHLIBQT_H
#define VSMATHLIBQT_H
...
public:
    ...
    /// Singleton pattern
    static VSMathLibQT* gInstance;

    /// Call this to get the single instance of VSMathLib
    static VSMathLibQT* getInstance (void);
    ...
    */
    ...
    /** Updates either the buffer or the uniform variables
      ...
      * \param aType any value from MatrixTypes
    */
    void matrixToGL(MatrixTypes aType, QOpenGLFunctionsType *context);
    ...
    /** Updates either the buffer or the uniform variables
      ...
      * \param aType any value from ComputedMatrixTypes
    */
    void matrixToGL(ComputedMatrixTypes aType, QOpenGLFunctionsType *context);
    ...
    */
    void matricesToGL(QOpenGLFunctionsType *context);
