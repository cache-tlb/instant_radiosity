...
#ifndef VSSHADERLIBQT_H
#define VSSHADERLIBQT_H
...
public:
    ...
    VSShaderLibQT(QOpenGLFunctionsType *context);
    ~VSShaderLibQT();
    ...
    */
    void loadShader(VSShaderLibQT::ShaderType st, std::string fileName);
    ...
    */
    void setVertexAttribName(VSShaderLibQT::AttribType at, std::string name);
    ...
    */
    ...
    static void setBlock(QOpenGLFunctionsType *context, std::string name, void *value);
    /// sets a uniform inside a named block
    static void setBlockUniform(QOpenGLFunctionsType *context, std::string blockName,
                                std::string uniformName,
                                void *value);
    /// sets an element of an array of uniforms inside a block
    static void setBlockUniformArrayElement(QOpenGLFunctionsType *context, std::string blockName,
                                std::string uniformName,
                                int arrayIndex,
                                void * value);
    ...
    GLuint getShaderIndex(VSShaderLibQT::ShaderType);

    /// returns a string with a shader's infolog
    std::string getShaderInfoLog(VSShaderLibQT::ShaderType);
    ...
    bool isShaderCompiled(VSShaderLibQT::ShaderType);
...
protected:
    ...
    static GLenum spGLShaderTypes[VSShaderLibQT::COUNT_SHADER_TYPE];

    /// stores the text string related to each type
    static std::string spStringShaderTypes[VSShaderLibQT::COUNT_SHADER_TYPE];

    /// aux string used to return the shaders infologs
    std::string pResult;

    /// stores the shaders and program indices
    GLuint pShader[VSShaderLibQT::COUNT_SHADER_TYPE], pProgram;
